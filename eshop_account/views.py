...
def register(request):
    ...
    if register_form.is_valid():
        ...
        User.objects.create_user(username=user_name, email=email, password=password, first_name=name, last_name=family)
...
def user_sidebar(request):
    return render(request, 'account/user_sidebar_partial.html', {})
